...
public class BetDAO {
    ...
    public BetDAO(String bookmakerName, String first, String draw, String second, String payout, MatchDAO matchDAO) {
        try{
            this.bookmakerName = new BookmakerDAO(bookmakerName);
    ...
    public BookmakerDAO getBookmakerName() {
        return bookmakerName;
    }

    public void setBookmakerName(BookmakerDAO bookmakerName) {
